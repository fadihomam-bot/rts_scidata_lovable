      ...
      <section className="legal__hero">
        <div className="legal__hero-container">
          <h1 className="legal__hero-title">
            <span className={gradientClass}>{t.legal.dataConfidentiality.title}</span>
          </h1>
          <p className="legal__hero-updated">{t.legal.dataConfidentiality.lastUpdated}</p>
        </div>
      </section>
      ...
      <section className="legal__content">
        <div className="legal__content-container">
          <div className="legal__section">
            <p className="legal__text">{t.legal.dataConfidentiality.intro}</p>
          </div>

          {t.legal.dataConfidentiality.sections.map((section, index) => (
